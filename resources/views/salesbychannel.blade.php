...
<ol class="breadcrumb">
    ...
    <li class="active">Sales By Channel</li>
</ol>
@endsection() @section('content')
<div class="callout callout-info">
    <h4>Information!</h4>
    <i class="fa fa-hand-o-right"></i> Sales by channel
</div>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <title class="box-title" style="font-weight:normal;">Search Sales By Channel</title>
            </div>
            <div class="box-body">
                <form action="{{ url('salesbychannelview') }}" method="POST" style="font-weight:normal;" autocomplete="off">
