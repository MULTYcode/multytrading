...
<div class="callout callout-info">
    <h4>Information!</h4>
    <i class="fa fa-hand-o-right"></i> Summary mutasi by store
</div>
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <title class="box-title" style="font-weight:normal;">Summary Mutasi By Store By Periode</title>
            </div>
            <div class="box-body">
                <form action="{{ url('mutasistoreview') }}" method="POST" style="font-weight:normal;" autocomplete="off">
